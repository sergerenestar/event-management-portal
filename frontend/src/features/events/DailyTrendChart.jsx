...
/**
 * Pivots flat snapshot rows into Recharts-friendly format:
 * [{date, "General Admission": 5, "VIP": 2}, ...]
 */
function pivotData(snapshots) {
  ...
  // Sort dates ascending (already ordered by backend, but be safe)
...
export default function DailyTrendChart({ snapshots = [] }) {
  ...
  const { rows, seriesNames } = pivotData(snapshots);
